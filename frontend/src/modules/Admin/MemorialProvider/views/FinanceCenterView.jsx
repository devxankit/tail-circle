...
import { Wallet, ArrowUpRight, ArrowDownRight, CheckCircle, Send, Clock, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-5 rounded-3xl border border-slate-100 shadow-sm">
        <div>
          ...
          <p className="text-sm font-semibold text-slate-500 mt-0.5">Real ledger and settlement data from paid services.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col justify-between">
          ...
          <button
            ...
            className="mt-2 w-full py-2.5 bg-slate-900 hover:bg-black disabled:bg-slate-200 disabled:text-slate-400 text-white rounded-xl text-sm font-bold flex items-center justify-center gap-2"
          >
