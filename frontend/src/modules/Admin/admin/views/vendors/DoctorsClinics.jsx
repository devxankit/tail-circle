...
export function DoctorsClinics() {
  ...
  const _unusedSeed = ([
    { id: 1, name: 'Dr. Priya Das', docId: '#DR001', clinic: 'PetCare Clinic', est: 'Est. 2018', mobile: '+91 98765 43210', email: 'Partner@tailcircle.in', contactPhone: '+91 98765 43210', contactEmail: 'Partner@tailcircle.in', city: 'Bangalore', state: 'KA', distance: '10km radius', spec: 'General Vet', modes: ['Clinic Visit', 'Video Call', 'Emergency'], appts: 12, apptsClinic: 8, apptsVideo: 3, apptsHome: 1, videoCalls: 3, fee: '₹500', extraFee: 'home +₹200', exp: 8, certs: ['BVSc', 'VCIN'], rating: '4.8', reviews: 142, response: 98, verified: 'Verified', status: 'Active' },
    { id: 2, name: 'Dr. Rohan Shah', docId: '#DR002', clinic: 'Happy Tails', est: 'Est. 2021', mobile: '+91 87654 32109', email: 'Partner@tailcircle.in', contactPhone: '+91 87654 32109', contactEmail: 'Partner@tailcircle.in', city: 'Hyderabad', state: 'TG', distance: 'Pan India (Video)', spec: 'Dermatology', modes: ['Video Call'], appts: 8, apptsClinic: 0, apptsVideo: 8, apptsHome: 0, videoCalls: 8, fee: '₹400', extraFee: null, exp: 5, certs: ['BVSc', 'MVSc'], rating: '4.6', reviews: 89, response: 95, verified: 'Pending', status: 'Active' },
    { id: 3, name: 'Dr. Anita Roy', docId: '#DR003', clinic: 'PawHealth', est: 'Est. 2015', mobile: '+91 76543 21098', email: 'Partner@tailcircle.in', contactPhone: '+91 76543 21098', contactEmail: 'Partner@tailcircle.in', city: 'Delhi', state: 'DL', distance: '5km radius', spec: 'Surgery', modes: ['Clinic Visit'], appts: 6, apptsClinic: 6, apptsVideo: 0, apptsHome: 0, videoCalls: 0, fee: '₹800', extraFee: null, exp: 12, certs: ['BVSc', 'MVSc', 'PhD'], rating: '4.9', reviews: 201, response: 99, verified: 'Verified', status: 'Active' },
    { id: 4, name: 'Dr. Suresh Kumar', docId: '#DR004', clinic: 'VetPlus', est: 'Est. 2020', mobile: '+91 65432 10987', email: 'Partner@tailcircle.in', contactPhone: '+91 65432 10987', contactEmail: 'Partner@tailcircle.in', city: 'Chennai', state: 'TN', distance: '15km radius', spec: 'Nutrition', modes: ['Clinic Visit', 'Home Visit', 'Video Call', 'Emergency'], appts: 9, apptsClinic: 3, apptsVideo: 4, apptsHome: 2, videoCalls: 4, fee: '₹350', extraFee: null, exp: 6, certs: ['BVSc', 'VCIN'], rating: '4.3', reviews: 67, response: 90, verified: 'Verified', status: 'Active' },
    { id: 5, name: 'Dr. Kavya Nair', docId: '#DR005', clinic: 'PetMed Center', est: 'Est. 2017', mobile: '+91 54321 09876', email: 'Partner@tailcircle.in', contactPhone: '+91 54321 09876', contactEmail: 'Partner@tailcircle.in', city: 'Mumbai', state: 'MH', distance: '20km radius', spec: 'Emergency', modes: ['Clinic Visit', 'Emergency'], appts: 14, apptsClinic: 10, apptsVideo: 0, apptsHome: 0, videoCalls: 0, fee: '₹600', extraFee: 'emerg +₹300', exp: 10, certs: ['BVSc', 'MVSc'], rating: '4.7', reviews: 178, response: 99, verified: 'Verified', status: 'Active' },
    { id: 6, name: 'Dr. Vivek Sharma', docId: '#DR006', clinic: 'City Pet Care', est: 'Est. 2022', mobile: '+91 99887 76655', email: 'Partner@tailcircle.in', contactPhone: '+91 99887 76655', contactEmail: 'Partner@tailcircle.in', city: 'Pune', state: 'MH', distance: '8km radius', spec: 'Dentistry', modes: ['Clinic Visit'], appts: 4, apptsClinic: 4, apptsVideo: 0, apptsHome: 0, videoCalls: 0, fee: '₹450', extraFee: null, exp: 4, certs: ['BVSc'], rating: '4.2', reviews: 34, response: 88, verified: 'Pending', status: 'Active' },
    { id: 7, name: 'Dr. Sneha Patil', docId: '#DR007', clinic: 'CareVet Clinic', est: 'Est. 2019', mobile: '+91 88776 65544', email: 'Partner@tailcircle.in', contactPhone: '+91 88776 65544', contactEmail: 'Partner@tailcircle.in', city: 'Jaipur', state: 'RJ', distance: '12km radius', spec: 'General Vet', modes: ['Clinic Visit', 'Video Call'], appts: 7, apptsClinic: 5, apptsVideo: 2, apptsHome: 0, videoCalls: 2, fee: '₹300', extraFee: null, exp: 7, certs: ['BVSc', 'VCIN'], rating: '4.5', reviews: 112, response: 92, verified: 'Pending', status: 'Active' },
    { id: 8, name: 'Dr. Ramesh Gupta', docId: '#DR008', clinic: 'Gupta Pet Hospital', est: 'Est. 2010', mobile: '+91 77665 54433', email: 'Partner@tailcircle.in', contactPhone: '+91 77665 54433', contactEmail: 'Partner@tailcircle.in', city: 'Kolkata', state: 'WB', distance: '25km radius', spec: 'Surgery', modes: ['Clinic Visit', 'Emergency'], appts: 18, apptsClinic: 15, apptsVideo: 0, apptsHome: 0, videoCalls: 0, fee: '₹1000', extraFee: null, exp: 18, certs: ['BVSc', 'MVSc', 'PhD'], rating: '4.9', reviews: 405, response: 96, verified: 'Pending', status: 'Active' },
    { id: 9, name: 'Dr. Meera Iyer', docId: '#DR009', clinic: 'Meera Vet', est: 'Est. 2023', mobile: '+91 66554 43322', email: 'Partner@tailcircle.in', contactPhone: '+91 66554 43322', contactEmail: 'Partner@tailcircle.in', city: 'Chennai', state: 'TN', distance: 'Pan India (Video)', spec: 'Nutrition', modes: ['Video Call'], appts: 5, apptsClinic: 0, apptsVideo: 5, apptsHome: 0, videoCalls: 5, fee: '₹250', extraFee: null, exp: 2, certs: ['BVSc'], rating: '4.1', reviews: 12, response: 100, verified: 'Pending', status: 'Active' },
    { id: 10, name: 'Dr. Arjun Kapoor', docId: '#DR010', clinic: 'Kapoor Animal Clinic', est: 'Est. 2016', mobile: '+91 55443 32211', email: 'Partner@tailcircle.in', contactPhone: '+91 55443 32211', contactEmail: 'Partner@tailcircle.in', city: 'Delhi', state: 'DL', distance: '10km radius', spec: 'Dermatology', modes: ['Clinic Visit', 'Home Visit'], appts: 11, apptsClinic: 8, apptsVideo: 0, apptsHome: 3, videoCalls: 0, fee: '₹550', extraFee: 'home +₹250', exp: 9, certs: ['BVSc', 'MVSc'], rating: '4.6', reviews: 215, response: 91, verified: 'Pending', status: 'Active' },
  ]);
  ...
  const handleStatusChange = async (id, newStatus) => {
    if (newStatus === 'Active') {
      const name = doctors.find(v => v.id === id)?.name;
